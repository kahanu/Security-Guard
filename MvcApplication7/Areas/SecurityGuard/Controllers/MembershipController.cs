...
using viewModels = MvcApplication7.Areas.SecurityGuard.ViewModels;

namespace MvcApplication7.Areas.SecurityGuard.Controllers
{
    ...
    public partial class MembershipController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public virtual ActionResult CheckForUniqueUser(string userName)
        {
        ...
        public virtual ActionResult UpdateUser(string UserName)
        {
            if (string.IsNullOrEmpty(UserName))
            {
                throw new ArgumentNullException("userName");
        ...
        [HttpPost]
        public virtual ActionResult Unlock(string userName)
        {
            JsonResponse response = new JsonResponse();
        ...
        [HttpPost]
        public virtual ActionResult ApproveDeny(string userName)
        {
            JsonResponse response = new JsonResponse();
        ...
        /// <returns></returns>
        [HttpPost]
        public virtual ActionResult RevokeRolesForUser(string userName, string roles)
        {
            JsonResponse response = new JsonResponse();
